[![Build status](https://ci.appveyor.com/api/projects/status/2lf34k81vgihkmh8/branch/master?svg=true)](https://ci.appveyor.com/project/nagraiv/async/branch/master)

# Домашнее задание к лекции «Promises, async/await» [ссылка](https://github.com/netology-code/ajs-homeworks/tree/ajs8/async)
